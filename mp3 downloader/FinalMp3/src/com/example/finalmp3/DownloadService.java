...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		public void downloadingfile(String link, String filename) throws IOException{	
			if(link.contains("hulkshare") || link.contains("zing")){
				...
				con.connect();
				if(link.contains("zing"))
					link = con.getHeaderField("Location").substring(0, con.getHeaderField("Location").indexOf("?"));
				else
	        ...
	        http--;
	        new SingleMediaScanner(DownloadService.this, file );
